...
export const ContactEditItem = ({contact, onSuccess}:ContactEditItemProps) => {
    ...
    const { trigger, isMutating } = useSWRMutation(`http://localhost:8080/agenda`, sendUpdate);
    ...
    return(
        ...
        className=" 
                 ...
                 <BsPencilFill className="text-secondary" size={28}/></button>
        <Modal.Root open={open} onOpenChange={setOpen} className="bg-white border-secondary border-3">
